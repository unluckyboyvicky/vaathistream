...
buttons = [
    [
        InlineKeyboardButton('⚡️Make Own Bot', url='https://github.com/unluckyboyvicky/vaathistream'),
        InlineKeyboardButton('🧩 Join Here', url='https://t.me/Tamil_1080p_Movies_HD'),
    ]
    ]
def get_cmd(dur):
    if dur:
